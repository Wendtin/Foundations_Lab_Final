...
**CIA Triad**
The CIA triad represents the three pillars of information security: confidentiality, integrity, and availability. It serves as a foundational framework for protecting information and is used as a checklist for security practitioners to ensure all angles of a security project are covered.
**AAA Framework**
